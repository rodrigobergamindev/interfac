...
import {Container,Description, Tab, HeaderRacao, ContainerTabs} from '../styles/styles.segmento'
...
export default function Racao() {
    ...
    return (
        ...
        <p>Confira abaixo algumas das funcionalidades do nosso sistema para uma loja de ração:</p>
