...
import {Container,Description, Tab, HeaderAviamentos, ContainerTabs} from '../styles/styles.segmento'
...
export default function Aviamentos() {
    ...
    return (
        ...
        <Head>
            <title>Comércio de Aviamentos</title>
        ...
        <p>Confira abaixo algumas das funcionalidades do nosso sistema para o segmento de Comércio de Aviamentos:</p>
