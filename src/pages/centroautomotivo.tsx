...
import {Container, Header, Description, Tab, Card, ContainerTabs} from '../styles/styles.segmento'
...
export default function Centro() {
    ...
    return (
        ...
        <p>Confira abaixo algumas das funcionalidades do nosso sistema para um centro automotivo:</p>
